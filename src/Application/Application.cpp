...
void Application::_Run()
{
	...
	while (_isRunning) {
		...
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableWarmCorrection);
		}
		else if (InputEngine::GetKeyState(GLFW_KEY_0) == ButtonState::Pressed)
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableHellCorrection);
		}


		else if (InputEngine::GetKeyState(GLFW_KEY_1) == ButtonState::Pressed)
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::DisableLighting);
		}
		...
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableAmbientSpecular);
		}

		else if (InputEngine::GetKeyState(GLFW_KEY_5) == ButtonState::Pressed)
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableAll);
		}

		else if (InputEngine::GetKeyState(GLFW_KEY_6) == ButtonState::Pressed)
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableDiffuseRamp);
		}
		else if (InputEngine::GetKeyState(GLFW_KEY_7) == ButtonState::Pressed)
		{
			GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableSpecularRamp);
		}
